<?php
	...
	require( 'specialsources/errorreporting/errorhandler.php' );
	...
	require( 'specialsources/PrivateSettings.php' );
	...
	# SVG converters
	$wgSVGConverters = array( 'ImageMagick' => '/usr/bin/convert $input -background transparent $output');
	...
	require( 'specialsources/mw-config/ExtensionSetup.php' );
